...
class ProductSalesChart extends Chart {
  ...
  Widget buildContent() {
    ...
    final state = bloc.state as SeriesLoaded<ProductSalesRecord, String, ProductSalesFilter>;
  ...
  Widget buildFilterDialog() {
    if (bloc.state is FilterableState) {
      final activeFilter = (bloc.state as FilterableState).activeFilter as ProductSalesFilter;

      return ProductSalesFilterDialog(
...
class ProductSalesFilterDialog extends StatefulWidget {
  final void Function(
    DateTime startDate,
    DateTime endDate,
    int limit,
  ...
  const ProductSalesFilterDialog({
    this.onApply,
    this.startDate,
    this.endDate,
    this.limit,
  ...
  @override
  _ProductSalesFilterDialogState createState() => _ProductSalesFilterDialogState();
}

class _ProductSalesFilterDialogState extends State<ProductSalesFilterDialog> {
  DateTime _startDate;
  DateTime _endDate;
  double _limit;
  int _sort;
